...
<head>
    ...
    <title>Adicionar matrícula - School Management</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 d-flex align-items-end justify-content-between">
                <h2 class="mt-3">Adicionar matrícula</h2>
            ...
            <div class="col-12">
                ...
                <form class="mt-5" method="POST">
                            ...
                            <select id="student_id" name="student_id" class="form-control" required>
                                ...
                                <?php foreach ($students as $student): ?>
                                    <option value="<?= $student['id'] ?>" 
                                        <?= isset($form['student_id']) && $form['student_id'] ==  $student['id'] ? 'selected' : null ?>>
                                        <?= $student['name'] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="mb-3 row">
                        <label for="class_id" class="col-sm-2 col-form-label">Turma</label>
                        <div class="col-sm-6">
                            <select id="class_id" name="class_id" class="form-control" required>
                                <option value="">Selecione</option>
                                <?php foreach ($classes as $class): ?>
                                    <option value="<?= $class['id'] ?>"
                                        <?= isset($form['class_id']) && $form['class_id'] ==  $class['id'] ? 'selected' : null ?>>
                                        <?= $class['name'] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
