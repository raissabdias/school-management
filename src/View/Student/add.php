...
<head>
    ...
    <title>Adicionar aluno - School Management</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 d-flex align-items-end justify-content-between">
                <h2 class="mt-3">Adicionar aluno</h2>
            ...
            <div class="col-12">
                ...
                <form class="mt-5" method="POST">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Informe seu nome completo" value="<?= $form['name'] ?? null ?>" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="birth_date" class="col-sm-2 col-form-label">Data de nascimento</label>
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="birth_date" name="birth_date" value="<?= $form['birth_date'] ?? null ?>" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="username" class="col-sm-2 col-form-label">Usuário</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="username" name="username" placeholder="Informe uma credencial para acesso" value="<?= $form['username'] ?? null ?>" required>
                        </div>
                    </div>
